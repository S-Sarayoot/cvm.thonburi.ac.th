<!-- Sidebar -->
<div class="min-w-[250px] min-h-screen bg-white py-2 px-2 max-md:hidden">
    <div class="p-4 rounded-lg shadow-md bg-[#74097e] h-[calc(100vh-20px)] text-purple-50">
        ...
        <hr class="text-white w-full mb-5">
            <div class="h-[calc(100%-70px)] justify-between flex flex-col">
